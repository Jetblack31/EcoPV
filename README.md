...
* **Puissance de la résistance commandée (W) (P_RESISTANCE).** Indiquez ici la puissance de la résistance électrique en Watts qui sera branchée et pilotée par EcoPV : chauffe-eau, radiateur électrique. Il est conseillé que la puissance ce cette résistance soit légèrement supérieure au surplus maximal que pourrait générer votre installation photovoltaïque. 
